...
//===----------------------------------------------------------------------===//
//
// This file contains device-side functions to support the dynamic memory
// heap in GPU global memory. The rationale is to replace builtin malloc/free
// calls, since they are incompatible with concurrent kernels execution.
//
//===----------------------------------------------------------------------===//
