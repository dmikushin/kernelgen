...
TYPE, BIND(C) :: KERNELGEN_COMPARE_MAXDIFF_T
  REAL(4) :: SINGLE
  REAL(8) :: DOUBLE
END TYPE KERNELGEN_COMPARE_MAXDIFF_T

TYPE(KERNELGEN_COMPARE_MAXDIFF_T) :: KERNELGEN_COMPARE_MAXDIFF = &
  KERNELGEN_COMPARE_MAXDIFF_T(1e-04, 1e-13)
...
TYPE, BIND(C) :: KERNELGEN_KERNEL_CONFIG
  ...
  INTEGER(C_INT) :: IPLATFORM, IDEVICE
  TYPE(C_PTR) :: SPECIFIC
  TYPE(C_PTR) :: STATS
