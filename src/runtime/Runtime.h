...
public:
  ...
  void reset() { x = y = z = -1; }
  Size3(int64_t _x, int64_t _y, int64_t _z) : x(_x), y(_y), z(_z) {}
...
KernelFunc Compile(int runmode, Kernel *kernel, llvm::Module *module = NULL,
                   void *data = NULL, int szdata = 0, int szdatai = 0);
...
extern "C" void kernelgen_hostcall(kernelgen::Kernel *kernel,
                                   ...
                                   llvm::StructType *StructTy, void *params);
