...
try t;
	...
	e->ref  = g95_full_ref(&e->where);
        e->ref->x.where.lb1 = e->ref->x.where.lb2 = e->x.where.lb2;
        e->ref->x.where.column1 = e->ref->x.where.column2 = e->x.where.column2;
    }
...
int m;
	...
	if (sym_upper != sym_lower) {
	    ...
	    sym_upper->as = g95_copy_array_spec(sym_lower->as);
            if( sym_upper->as )
              sym_upper->as->x.alias = sym_lower->as;
...
g95x_locus xw;
    ...
    if( ref != NULL ) {
      xw.lb1 = xw.lb2 = ref->x.where.lb1;
      xw.column1 = xw.column2 = ref->x.where.column1;
      new->x.where = xw;
    } else {
      xw.lb1 = xw.lb2 = e->x.where.lb1;
      xw.column1 = xw.column2 = e->x.where.column1;
      new->x.where = xw;
    }
...
g95_ref *ref;
	...
	ref->u.ar.type = AR_FULL;
        ref->x.where.lb2 = ref->x.where.lb1 = expr->x.where.lb2;
        ref->x.where.column2 = ref->x.where.column1 = expr->x.where.column2;
