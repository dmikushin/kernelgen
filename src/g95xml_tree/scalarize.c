 ...
 * the reference, minus any coarray references.  The expression node
 * is a variable node with a set of reference structures.  We keep
 * everything up to the array section reference.  The type of the
 * expression can change when trailing component references are
 * removed. */
