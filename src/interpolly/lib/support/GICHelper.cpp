...
void kernelgen::MPZ_from_APInt (mpz_t v, const APInt apint, bool is_signed)
{
...
APInt kernelgen::APInt_from_MPZ (const mpz_t mpz)
{
	uint64_t *p = NULL;
	size_t sz;
...
std::string kernelgen::stringFromIslObj(/*__isl_keep*/ isl_map *map)
{
...
std::string kernelgen::stringFromIslObj(/*__isl_keep*/ isl_set *set)
{
...
std::string kernelgen::stringFromIslObj(/*__isl_keep*/ isl_union_map *umap)
{
...
std::string kernelgen::stringFromIslObj(/*__isl_keep*/ isl_union_set *uset)
{
...
std::string kernelgen::stringFromIslObj(/*__isl_keep*/ isl_schedule *schedule)
{
