...
int i;
    ...
    g95x_locus xw1 = g95x_pop_locus();
    g95x_locus xw2 = g95x_pop_locus();
    g95x_push_locus( &xw2, G95X_LOCUS_USOP );
...
g95x_ext_locus* exw = NULL;
    ...
    if( m == MATCH_YES ) {
        ...
        g95x_locus xw1 = g95x_pop_locus();
        g95x_push_locus( &xw1, G95X_LOCUS_USOP );
        g95x_push_locus( &xw2, G95X_LOCUS_LANG );
    }
