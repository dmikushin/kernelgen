...
/* find_where_mask_temps()-- Find formall mask temporaries inside WHEREs. */
...
g95_expr *e;
    ...
    rank = p->old->as->rank;
    p->new = g95_get_temporary(&p->old->ts, rank);
...
g95_code *c;
    ...
    p->new = g95_get_temporary(&p->old->ts, 0);
