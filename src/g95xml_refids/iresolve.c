 ...
 * logical.  If not, conver it to that. */
...
/* charcat()-- Concatentate a character to a string */
...
static int xget_kind( g95_expr *kind ) {
    int ikind = 0;  
    if( g95x_simplify_none() && kind ) {
        g95_expr *kind1 = g95_copy_expr( kind );

        g95x_simplify_push( 0 );
        g95_simplify_expr( kind1 );
        g95x_simplify_pop();
  
        ikind = bi_to_int( kind1->value.integer );
    
        g95_free_expr( kind1 );
    } else if( kind )
        ikind = bi_to_int( kind->value.integer );
...
void g95_resolve_char(g95_expr *f, g95_expr *i, g95_expr *kind) {
    ...
    ikind = xget_kind( kind );
    if( ikind == 0 ) 
        ikind = g95_default_character_kind();
...
void g95_resolve_floor(g95_expr *f, g95_expr *a, g95_expr *kind) {
    ...
    ikind = xget_kind( kind );
    if( ikind == 0 ) 
        ikind = g95_default_integer_kind(1);
...
void g95_resolve_lbound(g95_expr *f, g95_expr *array, g95_expr *dim) {
    ...
    f->ts.type = BT_INTEGER;
    f->ts.kind = g95_default_integer_kind(0);
    f->value.function.iname = PREFIX "lbound";
...
void g95_resolve_logical(g95_expr *f, g95_expr *a, g95_expr *kind) {
    ...
    ikind = xget_kind( kind );
    if( ikind == 0 ) 
        ikind = g95_default_logical_kind();
...
void g95_resolve_real(g95_expr *f, g95_expr *a, g95_expr *kind) {
    ...
    ikind = xget_kind( kind );
    if( ikind == 0 ) 
        ikind = (a->ts.type == BT_COMPLEX) ? a->ts.kind : 
...
void g95_resolve_shape(g95_expr *f, g95_expr *array) {
    ...
    f->ts.kind = g95_default_integer_kind(0);
    f->rank = 1;
    f->value.function.iname = PREFIX "shape";
...
void g95_resolve_size(g95_expr *f, g95_expr *array, g95_expr *dim) {
    ...
    f->ts.type = BT_INTEGER;
    f->ts.kind = g95_default_integer_kind(0);
    f->value.function.iname = g95_get_fstring(PREFIX "size");
...
void g95_resolve_ubound(g95_expr *f, g95_expr *array, g95_expr *dim) {
    ...
    f->ts.type = BT_INTEGER;
    f->ts.kind = g95_default_integer_kind(0);
    f->value.function.iname = PREFIX "ubound";
