 ...
 * dimension attribute. */
    ...
    g95x_push_decl_list_symbol( sym );
    if( as1 ) 
...
success:
    g95x_push_decl_list_component( c );
    exw->u.mmbr.component = c;
    exw = NULL;
 ...
 * current attribute. */
	...
	if (g95_current_state() == COMP_DERIVED) {
		...
		d != DECL_COLON && d != DECL_NONE && d != DECL_ALLOCATABLE) {
...
/* match_bind()-- Match a bind specficiation */
...
match m;
	...
	if (g95_match_eos() == MATCH_YES) {
	    ...
	    m = match_suffix(function, (g95_current_state() == COMP_FUNCTION),
			     &result);
	    if (m == MATCH_NO)
...
match m;
	...
	case INTERFACE_INTRINSIC_OP:
		...
		goto done;
            ...
            g95x_push_decl_list_intr_op_idx( operator );
	...
	case INTERFACE_USER_OP:
		...
		goto done;
            ...
            g95x_push_decl_list_user_op( st );
...
match m;
	...
	g95_current_ns->seen_save = 1;
        ...
        exw->u.cmmn.common = (struct g95_common_head*)h;
        g95x_push_decl_list_common( h );
