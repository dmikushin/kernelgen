...
not_continuation:
    ...
    {  
        ...
        char* mask = g95_current_locus.lb->mask;
...
char c;
	...
	current_file->line = source_line(input, map, input->out.first_line);
        ...
        g95x_push_cpp_line( current_file );
...
static try load_file(char *filename1, char *filename2) {
...
int n;
    ...
    n = p - g95_source_file;
    search_prefix = g95_getmem(n+1);

    memcpy(search_prefix, g95_source_file, n);
    search_prefix[n] = '\0';
}
...
try t;
    ...
    t = load_file(g95_source_file, source);
