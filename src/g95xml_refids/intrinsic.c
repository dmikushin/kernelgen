...
static g95_intrinsic_arg *modproc_args[IPROC_LAST];
...
int m, dc, di0, di1, dr0, dr1, dd, dl;
    ...
    m = add_sym("besj0", 0, G95_ISYM_EXTENSION, BT_REAL, dd, &lib_name,
    ...
    m = add_sym("besj1", 0, G95_ISYM_EXTENSION, BT_REAL, dd, &lib_name,
    ...
    m = add_sym("besjn", 0, G95_ISYM_EXTENSION, BT_REAL, dd, &lib_name,
    ...
    m = add_sym("besy0", 0, G95_ISYM_EXTENSION, BT_REAL, dd, &lib_name,
    ...
    m = add_sym("besy1", 0, G95_ISYM_EXTENSION, BT_REAL, dd, &lib_name,
    ...
    m = add_sym("besyn", 0, G95_ISYM_EXTENSION, BT_REAL, dd, &lib_name,
...
int di0, di1, dr0, dr1, dd, dl, dc, dx, dq;
    ...
    add_sym("abs", 1, G95_ISYM_ABS, BT_UNKNOWN, 0,
    ...
    add_sym("acos", 1, G95_ISYM_ACOS, BT_UNKNOWN, 0,
    ...
    add_sym("aimag", 1, G95_ISYM_AIMAG, BT_UNKNOWN, 0,
    ...
    add_sym("aint", 1, G95_ISYM_AINT, BT_UNKNOWN, 0,
    ...
    add_sym("anint", 1, G95_ISYM_ANINT, BT_UNKNOWN, 0,
    ...
    add_sym("asin", 1, G95_ISYM_ASIN, BT_UNKNOWN, 0,
    ...
    add_sym("atan", 1, G95_ISYM_ATAN, BT_UNKNOWN, 0,
    ...
    add_sym("atan2", 1, G95_ISYM_ATAN2, BT_UNKNOWN, 0,
    ...
    add_sym("cos", 1, G95_ISYM_COS, BT_UNKNOWN, 0,
    ...
    add_sym("cosh", 1, G95_ISYM_COSH, BT_UNKNOWN, 0,
    ...
    add_sym("count", 0, G95_ISYM_COUNT, BT_INTEGER, di0, NULL,
	    ...
	    msk, BT_LOGICAL, dl, IARG_ARRAYDESC,
	    dm, BT_INTEGER, di1, IARG_OPTIONAL | IARG_ARRAYDESC, NULL);
    ...
    add_sym("epsilon", 0, G95_ISYM_EPSILON, BT_UNKNOWN, 0, NULL,
	    g95_check_x_ni, g95_simplify_epsilon, g95x_resolve_epsilon,
	    x, BT_REAL, dr0, IARG_NONE, NULL);

    make_generic("epsilon");

    add_sym("exp", 1, G95_ISYM_EXP, BT_UNKNOWN, 0,
    ...
    add_sym("huge", 0, G95_ISYM_HUGE, BT_UNKNOWN, 0, NULL,
	    g95_check_huge, g95_simplify_huge, g95x_resolve_huge,
	    x, BT_UNKNOWN, dr0, IARG_NONE,  NULL);
    ...
    add_sym("log", 1, G95_ISYM_LOG, BT_UNKNOWN, 0, NULL,
    ...
    add_sym("log10", 1, G95_ISYM_LOG10, BT_UNKNOWN, 0, NULL,
...
/* Note: amin0 is equivalent to real(min), min1 is equivalent to int(min). */
	...
	add_sym("amod", 1, G95_ISYM_MOD, BT_REAL, dr0,
		g95_get_fstring(PREFIX "mod_r%d", dr1),
		NULL, g95_simplify_mod, g95_resolve_mod,
		a, BT_REAL, dr1, IARG_NONE,
		p, BT_REAL, dr1, IARG_NONE, NULL);
    ...
    add_sym("shape", 0, G95_ISYM_SHAPE, BT_INTEGER, di0, NULL,
	    ...
	    src, BT_UNKNOWN, 0, IARG_ARRAYDESC, NULL);
    ...
    add_sym("sin", 1, G95_ISYM_SIN, BT_UNKNOWN, 0,
    ...
    add_sym("sqrt", 1, G95_ISYM_SQRT, BT_UNKNOWN, 0,
    ...
    add_sym("tan", 1, G95_ISYM_TAN, BT_UNKNOWN, 0,
    ...
    add_sym("tanh", 1, G95_ISYM_TANH, BT_UNKNOWN, 0,
    ...
    add_sym("tiny", 0, G95_ISYM_TINY, BT_UNKNOWN, 0, NULL,
	    g95_check_x_ni, g95_simplify_tiny, g95x_resolve_tiny,
    ...
    add_sym("ubound", 0, G95_ISYM_UBOUND, BT_INTEGER, di0, NULL,
	    ...
	    ar, BT_UNKNOWN, 0, IARG_ARRAYDESC,
	    dm, BT_INTEGER, di0, IARG_OPTIONAL, NULL);
...
static void add_modprocs(void) {
    ...
    add_modproc(IPROC_C_ASSOCIATED, "c_ptr1", 0, "c_ptr2", IARG_OPTIONAL,NULL);
    add_modproc(IPROC_C_F_POINTER, "cptr", 0, "fptr", IARG_INTENT_OUT,
		"shape", IARG_OPTIONAL, NULL);
    add_modproc(IPROC_C_F_PROCPOINTER, "cptr", 0, "fptr",IARG_INTENT_OUT,NULL);
...
g95_expr *result = NULL, *a1, *a2, *a3, *a4, *a5;
g95_actual_arglist *arg;
try t;
...
/* fix_array_args()-- Fix the argument type of array arguments. */
...
try t;
    ...
    if (t == SUCCESS) {
	arg_usage(modproc_args[sym->attr.iproc], expr->value.function.actual);
...
try t;
    ...
    if (t == SUCCESS) {
	c->sym = sym;
	arg_usage(modproc_args[sym->attr.iproc], c->ext.sub.actual);
    }
...
try rc;
	...
	g95_zero_size_array(expr)) { /* Sometimes the RHS acquires the type */
	expr->ts = *ts;
	goto done;
    }
