...
/* zero_sized()-- Return nonzero if the array has zero size */

static int zero_sized(g95_expr *array) {
g95_array_spec *as;
g95_ref *ref;
int i;
...
static g95_expr *simplify_bound(g95_expr *array, g95_expr *dim, int upper) {
g95_expr *result, *e;
g95_typespec ts;
int i;
...
g95_expr *g95_simplify_lbound(g95_expr *array, g95_expr *dim) {
...
int n, rank;
    ...
    g95_find_array_ref(source, &ar, &as);
    ...
    for(n=0; n<rank; n++) {
	e = g95_constant_result(BT_INTEGER, -1, &source->where);
...
int n, d;
	...
	if (array->shape != NULL)
	    ...
	    g95_find_array_ref(array, &ar, &as);
    ...
    result = g95_constant_result(BT_INTEGER, -1, &array->where);
...
g95_expr *g95_simplify_ubound(g95_expr *array, g95_expr *dim) {
...
int back;
	...
	index = len - strspn(s->value.character.string,
